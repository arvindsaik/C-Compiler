...
{
       0,    72,    72,    73,    74,    75,    76,    81,    82,    85,
      86,    87,    88,    89,    90,    91,    92,    93,    94,    95,
      96,   101,   102,   107,   112,   117,   120,   121,   127,   137,
     147,   159,   162,   163,   166,   168,   171,   173,   177,   207,
     226,   227,   228,   229,   230,   235,   236,   239,   241,   242,
     245,   256,   257,   258,   273,   277,   295,   315,   316,   319,
     320,   321,   322,   323,   324,   327,   328,   331,   332,   335,
     336,   339,   340,   343,   344,   347,   348,   349,   352,   353,
     354,   355,   356,   359,   360,   361,   364,   365,   366,   369,
     370,   371,   372,   373,   374,   375,   378,   379,   380,   381,
     382,   383,   387,   406,   407,   411,   412,   413,   416,   417,
     418,   419,   420,   421
};
#endif
...
#line 93 "parser.y" /* yacc.c:1646  */
    { if(strcmp(return_type, (yyvsp[-1].pair).dtype)!=0) printf("Return type is not correct at line: %d.\n", line);}
...
#line 101 "parser.y" /* yacc.c:1646  */
    {if(strcmp((yyvsp[-2].pair).dtype,"int") != 0){printf("expresion in if not of type int in line %d\n",line-1);}}
#line 1575 "y.tab.c" /* yacc.c:1646  */
    break;

  case 22:
#line 102 "parser.y" /* yacc.c:1646  */
    {if(strcmp((yyvsp[-4].pair).dtype,"int") != 0){printf("expresion in if not of type int in line %d\n",line-1);}}
#line 1581 "y.tab.c" /* yacc.c:1646  */
    break;

  case 23:
#line 107 "parser.y" /* yacc.c:1646  */
    {if(strcmp((yyvsp[-2].pair).dtype,"int") != 0){printf("expresion in while not of type int in line %d\n",line);}}
#line 1587 "y.tab.c" /* yacc.c:1646  */
    break;

  case 24:
#line 112 "parser.y" /* yacc.c:1646  */
    {if(strcmp((yyvsp[-2].pair).dtype,"int") != 0){printf("expresion in do while not of type int in line %d\n",line);}}
...
#line 166 "parser.y" /* yacc.c:1646  */
    {strcpy(temp[++num_params].datatype, (yyvsp[-3].pair).dtype);
																st[++top] = brack_num+1;install_symbol((yyvsp[-2].lval), (yyvsp[-3].pair).dtype, st, top,-1, return_type, temp, num_params, 0);	top--;}
...
#line 171 "parser.y" /* yacc.c:1646  */
    {strcpy(temp[++num_params].datatype, (yyvsp[-1].pair).dtype);
												st[++top] = brack_num+1;install_symbol((yyvsp[0].lval), (yyvsp[-1].pair).dtype, st, top,-1, return_type, temp, num_params, 0);	top--;}
...
#line 316 "parser.y" /* yacc.c:1646  */
    {strcpy((yyval.pair).dtype,(yyvsp[0].pair).dtype);strcpy((yyval.pair).id_or_const,(yyvsp[0].pair).id_or_const);}
#line 1869 "y.tab.c" /* yacc.c:1646  */
    break;

  case 59:
#line 319 "parser.y" /* yacc.c:1646  */
    {if(strcmp((yyvsp[-2].pair).dtype,(yyvsp[0].pair).dtype) == 0 || strcmp(ret_type((yyvsp[-2].pair).dtype, (yyvsp[0].pair).dtype), (yyvsp[-2].pair).dtype)==0) {strcpy((yyval.pair).dtype,(yyvsp[-2].pair).dtype); strcpy((yyval.pair).id_or_const,rnum);printf("%s = %s\n",(yyvsp[-2].pair).id_or_const,(yyvsp[0].pair).id_or_const);rnum[1]++; rnum[1] = '0';} else {printf("Type mismatch at line %d\n",line);strcpy((yyval.pair).dtype,(yyvsp[-2].pair).dtype);} }
...
#line 324 "parser.y" /* yacc.c:1646  */
    {strcpy((yyval.pair).dtype, (yyvsp[0].pair).dtype);strcpy((yyval.pair).id_or_const,(yyvsp[0].pair).id_or_const);rnum[1] = '0';}
#line 1905 "y.tab.c" /* yacc.c:1646  */
    break;

  case 65:
#line 327 "parser.y" /* yacc.c:1646  */
    {strcpy((yyval.pair).dtype,"int");strcpy((yyval.pair).id_or_const,rnum);printf("%s = %s || %s\n",rnum,(yyvsp[-2].pair).id_or_const,(yyvsp[0].pair).id_or_const);rnum[1]++;}
...
#line 359 "parser.y" /* yacc.c:1646  */
    {strcpy((yyval.pair).dtype,ret_type((yyvsp[-2].pair).dtype,(yyvsp[0].pair).dtype));strcpy((yyval.pair).id_or_const,rnum);printf("%s = %s + %s\n",rnum,(yyvsp[-2].pair).id_or_const,(yyvsp[0].pair).id_or_const);rnum[1]++;}
...
#line 378 "parser.y" /* yacc.c:1646  */
    {strcpy((yyval.pair).dtype, (yyvsp[-1].pair).dtype);strcpy((yyval.pair).id_or_const,(yyvsp[-1].pair).id_or_const);}
...
#line 411 "parser.y" /* yacc.c:1646  */
    {strcpy((yyval.pair).dtype, "float"); sprintf((yyval.pair).id_or_const,"%f",(yyvsp[0].val)) ;char temp[20]; }
#line 2169 "y.tab.c" /* yacc.c:1646  */
    break;

  case 106:
#line 412 "parser.y" /* yacc.c:1646  */
    {strcpy((yyval.pair).dtype, "int"); sprintf((yyval.pair).id_or_const,"%.0f",(yyvsp[0].val)) ;char temp[20]; }
#line 2175 "y.tab.c" /* yacc.c:1646  */
    break;

  case 107:
#line 413 "parser.y" /* yacc.c:1646  */
    {strcpy((yyval.pair).dtype, "char"); sprintf((yyval.pair).id_or_const,"%s",(yyvsp[0].val2)) ;char temp[20]; }
#line 2181 "y.tab.c" /* yacc.c:1646  */
    break;

  case 108:
#line 416 "parser.y" /* yacc.c:1646  */
    {strcpy(id, (yyvsp[0].lval)); strcpy((yyval.pair).dtype, (yyvsp[0].lval));}
...
#line 418 "parser.y" /* yacc.c:1646  */
    {strcpy(id, (yyvsp[0].lval)); strcpy((yyval.pair).dtype, id);}
...
#line 420 "parser.y" /* yacc.c:1646  */
    {strcpy(id, (yyvsp[0].lval)); strcat(id, "_u");strcpy((yyval.pair).dtype, id);}
