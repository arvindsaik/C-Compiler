...
{
       0,    56,    56,    57,    58,    59,    60,    65,    66,    69,
      70,    71,    72,    73,    74,    75,    76,    77,    78,    79,
      84,    85,    90,    95,   100,   103,   104,   110,   112,   114,
     118,   121,   122,   125,   127,   129,   131,   133,   135,   139,
     140,   143,   144,   145,   146,   147,   148,   153,   154,   157,
     159,   160,   163,   164,   165,   166,   171,   172,   175,   176,
     177,   178,   179,   184,   187,   192,   193,   196,   197,   198,
     ...
     264,   265,   266,   270,   271,   274,   275,   276,   277,   278,
     279
};
#endif
...
#line 110 "parser.y" /* yacc.c:1646  */
    {strcpy(return_type, (yyvsp[-4].lval));
																								install_symbol((yyvsp[-3].lval),id, st, top,-1, return_type, 	temp, num_params,1); num_params=-1;}
...
#line 125 "parser.y" /* yacc.c:1646  */
    {strcpy(temp[++num_params].datatype, "void");
																st[++top] = brack_num+1;install_symbol((yyvsp[-2].lval), id, st, top,-1, return_type, temp, num_params, 0);	top--; }
...
#line 129 "parser.y" /* yacc.c:1646  */
    {strcpy(temp[++num_params].datatype, "void");
																st[++top] = brack_num+1;strcpy(id, (yyvsp[-3].lval));install_symbol((yyvsp[-2].lval),id, st, top,-1, return_type, temp, num_params, 0);	top--;}
...
#line 131 "parser.y" /* yacc.c:1646  */
    {strcpy(temp[++num_params].datatype, "void");
										strcpy(id, (yyvsp[-1].lval)); st[++top] = brack_num+1;install_symbol((yyvsp[0].lval), id, st, top,-1, return_type, temp, num_params, 0);	top--;}
...
#line 133 "parser.y" /* yacc.c:1646  */
    {strcpy(temp[++num_params].datatype, id);
												st[++top] = brack_num+1;install_symbol((yyvsp[0].lval), id, st, top,-1, return_type, temp, num_params, 0);	top--;}
...
#line 163 "parser.y" /* yacc.c:1646  */
    {install_symbol((yyvsp[-2].lval), id, st, top,-1, return_type, temp, num_params, 0);}
...
#line 184 "parser.y" /* yacc.c:1646  */
    { strcat(id,"_array");install_symbol((yyvsp[-3].lval), id, st, top,(yyvsp[-1].val), return_type, temp, num_params, 0);}
...
#line 196 "parser.y" /* yacc.c:1646  */
    {if(strcmp((yyvsp[-2].lval),(yyvsp[0].lval)) == 0) strcpy((yyval.lval),(yyvsp[-2].lval)); else {printf("Type mismatch\n");yyerror(" ");strcpy((yyval.lval),"char");}}
...
#line 264 "parser.y" /* yacc.c:1646  */
    {sprintf((yyval.lval),"%s",get_datatype((yyvsp[0].lval),st,top));if(strcmp("printf",(yyvsp[0].lval))!=0){char tempo[256]; strcpy(tempo,(yyvsp[0].lval));if(check_scope(tempo) == 0){printf("line %d : %s is out of scope\n",line,tempo);yyerror(" ");}}}
